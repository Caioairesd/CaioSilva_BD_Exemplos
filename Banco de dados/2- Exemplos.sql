...
CREATE TABLE `fornecedor` (
  ...
  `nome_fornecedor` varchar(35) DEFAULT NULL,
  `marca_fornecedor` varchar(35) DEFAULT NULL,
  `email_fornecedor` varchar(35) DEFAULT NULL,
  `telefone_fornecedor` varchar(35) DEFAULT NULL,
  `cidade_fornecedor` varchar(35) DEFAULT NULL,
  `pais_fornecedor` varchar(35) DEFAULT NULL,
...
CREATE TABLE `funcionario` (
  ...
  `cpf_funcionario` varchar(35) DEFAULT NULL,
  `cidade_funcionario` varchar(35) DEFAULT NULL,
  `estado_funcionario` varchar(35) DEFAULT NULL,
  `telefone_funcionario` varchar(35) DEFAULT NULL,
  `email_funcionario` varchar(35) DEFAULT NULL,
  `usuario_funcionario` varchar(35) DEFAULT NULL,
  `senha_funcionario` varchar(35) DEFAULT NULL,
...
CREATE TABLE `tabcidade` (
  `cidID` int NOT NULL,
  `cidNome` varchar(200) DEFAULT NULL,
  `cid_estID` int DEFAULT NULL,
  PRIMARY KEY (`cidID`),
...
-- Dump completed on 2025-04-11 22:07:05
