...
--
-- Host: localhost    Database: caio_silvasql
-- ------------------------------------------------------
...
CREATE TABLE `item` (
  ...
  PRIMARY KEY (`coditem`),
  KEY `fk_compra` (`codcompra`),
  KEY `fk_codprod` (`codprod`),
  CONSTRAINT `fk_codprod` FOREIGN KEY (`codprod`) REFERENCES `produto` (`codprod`),
  CONSTRAINT `fk_compra` FOREIGN KEY (`codcompra`) REFERENCES `compra` (`codcompra`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `item` VALUES (990,'500','990',120),(991,'500','600',325),(992,'500','300',20),(993,'500','200',53),(994,'500','400',10),(995,'502','100',20),(996,'502','200',10),(997,'502','800',5),(998,'502','700',3),(999,'503','990',4),(1000,'503','500',3),(1001,'504','100',5),(1002,'504','900',8),(1003,'504','990',4),(1004,'505','100',6),(1005,'505','200',11),(1006,'506','600',23),(1007,'506','500',7),(1008,'507','300',9),(1009,'508','800',4),(1010,'509','400',9),(1011,'510','990',20),(1012,'511','700',32),(1013,'511','100',5),(1014,'510','300',3),(1015,'512','100',25),(1016,'513','500',20),(1017,'513','200',75),(1018,'514','800',25),(1019,'514','600',41),(1020,'515','600',44),(1021,'515','500',23),(1022,'516','300',5),(1023,'516','400',10),(1024,'516','500',27),(1025,'517','300',16),(1026,'517','200',41),(1027,'518','100',51),(1028,'519','500',19),(1029,'520','300',9),(1030,'521','700',17),(1031,'522','900',4),(1032,'523','300',2);
...
-- Dump completed on 2025-04-11 22:08:31
